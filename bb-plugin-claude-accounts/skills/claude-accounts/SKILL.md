...
Use the plugin page for OAuth codes. Never request or paste codes into chat, commands, settings, logs, or files. The plugin does not collect or copy OAuth tokens. Inspect its per-machine result before claiming a switch succeeded.

A work account can spend paid extra usage until the user switches away. This plugin does not monitor quotas or switch accounts automatically.
