...
const PROVIDER_COLORS: Readonly<Record<string, string>> = {
  ...
  pi: "text-[#6D5DFB]",
  "acp-cursor": "text-muted-foreground",
  "acp-grok": "text-muted-foreground",
};

/** BB does not export its provider icons, so this mirrors its small built-in map. */
